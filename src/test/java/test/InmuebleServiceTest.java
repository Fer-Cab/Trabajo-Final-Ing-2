...
public class InmuebleServiceTest {
	...
	public void getAllInmueblesTest() throws ClassNotFoundException, SQLException, IOException {
		...
		assertEquals(
				"[Inmueble [inmuebleId=1, inmuebleLists=null, descripcion=descripcion, tipoDeInmueble=tipoDeInmueble, tipoDeOperacion=tipoDeOperacion, tipoDeEstado=tipoDeEstado, estado=estado, direccion=direccion, piso=1, dpto=d, ciudad=ciudad, provincia=provincia, numHabitaciones=1, banios=1, m2=1, alquiler=1.0, venta=1.0, tipoSuelo=tipoSuelo, garage=true, ascensor=true, amueblado=true, comision=1.0], Inmueble [inmuebleId=2, inmuebleLists=null, descripcion=descripcion2, tipoDeInmueble=tipoDeInmueble2, tipoDeOperacion=tipoDeOperacion2, tipoDeEstado=tipoDeEstado2, estado=estado2, direccion=direccion2, piso=2, dpto=e, ciudad=ciudad2, provincia=provincia2, numHabitaciones=2, banios=2, m2=2, alquiler=2.0, venta=2.0, tipoSuelo=tipoSuelo2, garage=true, ascensor=true, amueblado=true, comision=2.0]]",
	...
	public void updateInmuebleTest() throws ClassNotFoundException, SQLException, IOException {
		...
		assertEquals(
				"Inmueble [inmuebleId=1, inmuebleLists=null, descripcion=descripcion3, tipoDeInmueble=tipoDeInmueble3, tipoDeOperacion=tipoDeOperacion3, tipoDeEstado=tipoDeEstado3, estado=estado3, direccion=direccion, piso=1, dpto=d, ciudad=ciudad3, provincia=provincia3, numHabitaciones=3, banios=3, m2=3, alquiler=3.1, venta=3.1, tipoSuelo=tipoSuelo3, garage=false, ascensor=false, amueblado=true, comision=3.1]",
				InmuebleService.findByDireccionAndPisoAndDpto("direccion", "1", "d",con).toString());
	}
