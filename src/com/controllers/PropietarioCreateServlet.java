...
/**
 * Servlet implementation class ClienteCreateServlet
 */
@WebServlet("/ClienteCreateServlet")
public class PropietarioCreateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PropietarioCreateServlet() {
		super();
