...
public class ClienteService {
	...
	public static Cliente findByTipoDocAndNumDoc(String tipoDoc, int numDoc)
	...
	public static void deleteCliente(Long id) throws ClassNotFoundException, SQLException, IOException {
		Connection con = Conexion.getConexion();
