...
public class PropietarioService {
	...
	public static Propietario findByTipoDocAndNumDoc(String tipoDoc, int numDoc,Connection con)
	...
	public static void updatePropietario(Propietario propietario,Connection con)
			throws ClassNotFoundException, SQLException, IOException {
		Propietario prop = findByTipoDocAndNumDoc(propietario.getTipoDoc(), propietario.getNumDoc(),con);
		//Connection con = Conexion.getConexion();
	...
	public static void deletePropietario(Long id,Connection con) throws ClassNotFoundException, SQLException, IOException {
	//	Connection con = Conexion.getConexion();
	...
	public static List<Propietario> getAllPropietarios(Connection con) throws ClassNotFoundException, SQLException, IOException {
		//Connection con = Conexion.getConexion();
